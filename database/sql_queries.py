...
UPDATE telegram_users SET REFERENCE_LINK = ? WHERE TELEDRAM_ID = ?
'''
...
UPDATE telegram_users SET BALANCE = COALESCE(BALANCE,0) + 100 WHERE TELEDRAM_ID = ?
'''
